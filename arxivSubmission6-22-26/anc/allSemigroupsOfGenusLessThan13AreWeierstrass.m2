///
To verify the theorem announced in the title of this file,
either execute the code line by line, or load the file as indicated at the end of this file.
///
...
The file "smoothingFamilies.dbm" contains smoothing families for all semigroups of genus 
...
restart
-- load  the following file and hence to verify its title takes about 15 minutes
