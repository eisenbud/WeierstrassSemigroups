...
if it satisfies the conditions (1), (2) and (3) of Proposition \ref{stability of conditions}
\end{definition}
...
Here is an outline of the computation we made for each semigroup to find a smoothing family. In the first steps we work over a finite field $\ZZ/p$ for computational efficiency. To aid in the eventual lifting to characteristic 0 we took $p$ on the order of $10^{7}$.
...
Restricting to deformation parameters in certain range of degrees, e.g. degrees $>b$, can make the computation
